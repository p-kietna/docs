Here’s a refactored version of your `reduce`-based chunk uploader that uses `Promise.allSettled`, filters out failed uploads, and retries them in the next chunk:
